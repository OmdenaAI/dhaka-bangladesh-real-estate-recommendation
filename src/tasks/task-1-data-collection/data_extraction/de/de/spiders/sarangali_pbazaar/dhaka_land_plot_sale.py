...
class DataExtractionSpider(scrapy.Spider):
    ...
    def parse_details_page(self, response):
        ...
        item['view'] = response.css('div.property-amenities span.fullwidth:contains("View") strong::text').get()
        item['size_in_katha'] = response.css('div.property-amenities:nth-of-type(2) span.fullwidth:contains("Land Size") strong::text').get()
