...
class DataExtractionSpider(scrapy.Spider):
    name = "shop_sale"
    start_urls = ["https://pbazaar.com/en/shop-for-sale"]
    ...
    def parse_details_page(self, response):
        ...
        item['floor'] = response.css('div.property-amenities span.fullwidth strong::text').get()
        item['area_sft'] = response.css('div.property-amenities:nth-of-type(2) span.fullwidth:contains("Space Size") strong::text').get()
        #item['road_width'] =  response.css('div.property-amenities:nth-of-type(1) strong::text').get()
        yield item
