...
class DataExtractionSpider(scrapy.Spider):
    name = "garage_rent"
    start_urls = ["https://pbazaar.com/en/garage-to-rent"]
    ...
    def parse_details_page(self, response):
        ...
        item['floor_type'] = response.css(
            'div.property-amenities span.fullwidth:contains("floor type") strong::text').get()
        item['garage_number'] = response.css(
            'div.property-amenities span.fullwidth:contains("Garage Number") strong::text').get()
