...
class DataExtractionSpider(scrapy.Spider):
    ...
    def parse_details_page(self, response):
        ...
        item['area_sft'] = response.css('div.property-amenities span.fullwidth:contains("sft Space") strong::text').get()
        item['attach_bathrooms'] = response.css('div.property-amenities span.fullwidth:contains("Attached Bath(s)") strong::text').get()
        item['bedrooms'] = response.css('div.property-amenities span.fullwidth:contains("Bed(s)") strong::text').get()
        item['common_bathrooms'] = response.css('div.property-amenities:nth-of-type(5) span.fullwidth:contains("Common Bath(s)") strong::text').get()
        item['floor'] = response.css('div.property-amenities:nth-of-type(3) span.fullwidth:contains("Floor") strong::text').get()
        item['parking_space'] = response.css('div.property-amenities span.fullwidth:contains("Parking(s)") strong::text').get()
